    ...
    <div style={{ fontFamily: 'var(--font-sans)', color: 'var(--charcoal)' }}>
      ...
      <section style={{
        ...
        <div style={{ position: 'relative', maxWidth: 720, margin: '0 auto' }}>
          ...
          <p style={{ fontSize: 18, color: 'rgba(255,255,255,0.75)', maxWidth: 540, margin: '0 auto 40px', lineHeight: 1.7 }}>
      ...
      {/* Stats */}
      <section style={{ background: 'var(--navy-dark)', padding: '40px' }}>
        <div style={{ maxWidth: 800, margin: '0 auto', display: 'flex', justifyContent: 'center', gap: 80, flexWrap: 'wrap' }}>
          {stats.map(s => (
            <div key={s.label} style={{ textAlign: 'center' }}>
              <div style={{ fontSize: 36, fontWeight: 900, color: 'var(--emerald-light)', lineHeight: 1 }}>{s.value}</div>
      ...
      {/* Features */}
      <section style={{ padding: '100px 40px', background: 'var(--gray-50)' }}>
        <div style={{ maxWidth: 960, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 60 }}>
            <h2 style={{ fontSize: 36, fontWeight: 800, color: 'var(--navy)', letterSpacing: '-0.02em' }}>
              Everything you need to land the interview
            </h2>
            <p style={{ color: 'var(--gray-500)', marginTop: 12, fontSize: 16 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 24 }}>
            {features.map(f => (
              <div key={f.title} style={{
                background: 'white', borderRadius: 'var(--radius-lg)', padding: '32px 24px',
      ...
      <section id="pricing" style={{ padding: '100px 40px', background: 'white' }}>
        <div style={{ maxWidth: 820, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 60 }}>
            <h2 style={{ fontSize: 36, fontWeight: 800, color: 'var(--navy)', letterSpacing: '-0.02em' }}>Simple, transparent pricing</h2>
